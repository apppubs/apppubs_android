...
{
	public static final String EXTRA_BOOLEAN_EDITABLE = "editable";
	...
	private boolean mNeedButtons = false;
	...
	public void onCreate(final Bundle savedInstanceState)
	{
		...
		mNeedButtons = getIntent().getBooleanExtra(EXTRA_BOOLEAN_EDITABLE, mNeedButtons);
