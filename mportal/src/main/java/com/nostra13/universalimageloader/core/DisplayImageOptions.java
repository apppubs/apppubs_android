 ...
 * @since 1.0.0
 * 
 * 2015-02-26:新增参数 denyNetworkDownload ：是否不请求网络
 */
public final class DisplayImageOptions {
	...
	private final boolean denyNetworkDownload;
	...
	private DisplayImageOptions(Builder builder) {
		...
		denyNetworkDownload = builder.isDenyNetworkDownload;
	}
	...
	public boolean isDenyNetworkDownload() {
	...
	public static class Builder {
		...
		private boolean isDenyNetworkDownload;
		public Builder() {
		...
		public Builder denyNetworkDownload(boolean deny){
			isDenyNetworkDownload = deny;
			return this;
		}
		/**
		 * Incoming drawable will be displayed in {@link com.nostra13.universalimageloader.core.imageaware.ImageAware
