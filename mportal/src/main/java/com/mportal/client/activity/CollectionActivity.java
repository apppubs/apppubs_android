...
import com.mportal.client.adapter.MyFragementAdapter;
import com.mportal.client.bean.Collection;
import com.mportal.client.fragment.CollectionFragment1;
...
public class CollectionActivity extends BaseActivity implements OnClickListener, OnPageChangeListener {
	...
	public static String COLLECTIONDELECTACTION = "com.mportal.client.activity.delete";
