...
public enum WMHHttpErrorCode {
	UNKNOWN(0,"未知错误"),PARAMETER_ERROR(1,"参数错误"),DOWNLOAD_CANCELED(2,"取消请求"),FILE_NOT_EXIST(3,"请求地址不存在"), MALFORMEDA_URL(4,"错误的请求地址"),IO_EXCEPTION(5,"IO异常"),JSON_PARSE_ERROR(6,"JSON解析错误");
