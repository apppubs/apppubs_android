...
public abstract class HomeBaseActivity extends BaseActivity {
    ...
    protected void onCreate(android.os.Bundle arg0) {
        ...
        if (AppContext.getInstance(mContext).getCurrentUser().getMenuPower() != null) {
            ...
            mPrimaryMenuList = SugarRecord.find(MenuItem.class, "LOCATION=? and (PROTECTED_FLAG =" +
							" 0 or ID in (" + sqlParam + "))",
            ...
            public void onDone(final UserInfo obj) {
                ...
                RongIM.setUserInfoProvider(new RongIM.UserInfoProvider() {
                    ...
                    public io.rong.imlib.model.UserInfo getUserInfo(String userId) {
                        ...
                        io.rong.imlib.model.UserInfo ui = new io.rong.imlib.model.UserInfo(ubi
								.getUserId(), ubi.getTrueName(), Uri.parse(ubi.getAtatarUrl()));
...
//		mAppContext.setApp(app);
    ...
    private static boolean isNeedLogin(AppContext context) {
        return context.getCurrentUser() == null || TextUtils.isEmpty(context.getCurrentUser()
				.getUserId());
    }
    ...
    protected void onDestroy() {
        ...
        if (mAppContext.getApp().getLoginFlag() == App.LOGIN_ONSTART_USE_USERNAME_PASSWORD &&
