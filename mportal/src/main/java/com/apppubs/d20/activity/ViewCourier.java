...
import com.apppubs.d20.fragment.ChannelPictureFragment;
import com.apppubs.d20.fragment.ChannelVideoFragment;
import com.apppubs.d20.fragment.ChannelsFragment;
import com.apppubs.d20.fragment.ChannelsSlideFragment;
import com.apppubs.d20.fragment.ChannelsSquareFragment;
import com.apppubs.d20.fragment.CollectionFragment;
import com.apppubs.d20.fragment.CommonFragmentFactory;
import com.apppubs.d20.fragment.ConversationFragment;
import com.apppubs.d20.fragment.ExceptionFragment;
import com.apppubs.d20.fragment.HistoryFragment;
import com.apppubs.d20.fragment.MenuGroupsFragment;
import com.apppubs.d20.fragment.MoreFragment;
import com.apppubs.d20.fragment.MsgRecordListFragment;
import com.apppubs.d20.page.PageFragment;
...
import com.apppubs.d20.fragment.WeiBoFragment;
import com.apppubs.d20.message.fragment.AddressBookFragement;
import com.apppubs.d20.message.fragment.ConversationListFragment;
...
//			bundle.putString("httpPort","9090");	//http端口
    ...
    public void executeInHomeActivity(MenuItem item, final HomeBaseActivity mHomeActivity) {
        ...
        // 重复点击直接返回
        if (mCurMenuItem != null && mCurMenuItem.getId() == item.getId() && type == MenuItem
        ...
        if (!(!TextUtils.isEmpty(needTitleBarFlag) && needTitleBarFlag.equals("0")) && item
                .getTitleBarShowFlag() == MenuItem.TITLEBAR_SHOW_FLAG_TRUE) {
        ...
        } else if ((uri.startsWith("http://") || uri.startsWith("https://")) && type == MenuItem
        ...
        } else if (uri.equals(MenuItem.MENU_URL_WEIBO) && type == MenuItem.MENU_LOCATION_PRIMARY)
        {// 微博界面
            ...
            List<NewsChannel> channelList = SugarRecord.find(NewsChannel.class, "TYPE_ID=?", new
                    String[]{channelTypeId + ""}, null, "DISPLAY_ORDER", null);
        ...
        } else if (uri.equals(MenuItem.MENU_URL_HISTORY_MESSAGE) && type == MenuItem
            ...
            ContainerActivity.startActivity(mHomeActivity, HistoryFragment.class, null, "历史消息");
                ...
                && type == MenuItem.MENU_LOCATION_PRIMARY) {
//            frg = new ConversationFragment();
            ...
            mHomeActivity.startActivity(intent);
        } else if (uri.equals(MenuItem.MENU_URL_FAVORITE) && type == MenuItem
            ...
            frg.setArguments(args);
            mHomeActivity.changeContent(frg);
        } else if (uri.equals(MenuItem.MENU_URL_MENU) || uri.startsWith("apppubs://menugroups"))
        {// 逻辑菜单
            ...
            mFragmentsMap.put(item, frg);
            mHomeActivity.changeContent(frg);
        } else if (uri.equals(MenuItem.MENU_URL_ADDRESSBOOK) && type == MenuItem
                .MENU_LOCATION_PRIMARY) {
            Bundle args = new Bundle();
        ...
        } else if (uri.equals(MenuItem.MENU_URL_SETTING) && type == MenuItem
                .MENU_LOCATION_PRIMARY) {
