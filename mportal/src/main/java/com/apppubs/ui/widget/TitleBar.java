...
public class TitleBar extends RelativeLayout {
    ...
    public TitleBar(Context context, AttributeSet attrs) {
        ...
        mLeftTextSize = ta.getDimension(R.styleable.TitleBar_leftTextSize, Utils.dip2px(context,
                15));
        ...
        mLeftBtn.setPadding(mContext.getResources().getDimensionPixelSize(R.dimen
                .title_padding_left), 0, mContext
        ...
        mRightBtn.setPadding(mContext.getResources().getDimensionPixelSize(R.dimen
                .title_padding_left), 0, mContext
                .getResources().getDimensionPixelSize(R.dimen.title_padding_right), 0);
    ...
    public void setLeftView(View view) {
        ...
        mCurLeftView = view;
        mCurLeftView.setPadding(mContext.getResources().getDimensionPixelSize(R.dimen
                .title_padding_left), 0, mContext
                .getResources().getDimensionPixelSize(R.dimen.title_padding_right), 0);
    ...
    public void setLeftImageDrawable(Drawable drawable) {
        ...
        ib.setPadding(getResources().getDimensionPixelSize(R.dimen.title_padding_left), 0,
    ...
    public void setLeft2ndBtnWithImageResourceId(int resId) {
        ...
        ib.setScaleType(ScaleType.CENTER_INSIDE);
        ib.setHightLightColor(getResources().getColor(R.color.button_white_hight_color));
        ib.setPadding(0, getResources().getDimensionPixelSize(R.dimen.title_padding_left),
                mContext.getResources()
    ...
    public void setAddressText(String text) {
        if (mCurLeftView != null && !(mCurLeftView instanceof AddressTitleBarLabel)) {
            removeView(mCurLeftView);
        }
        ...
        mAddressLabel.setText(text);
        mCurLeftView  =mAddressLabel;
    }
    ...
    public void setLeftBtnWithImageResourceId(int resId) {
        ...
        ib.setHightLightColor(getResources().getColor(R.color.button_white_hight_color));
        ib.setPadding(getResources().getDimensionPixelSize(R.dimen.title_padding_left),
                getResources()
    ...
    public void addLeftBtnWithImageUrlAndClickListener(String imageUrl, Object tag,
     ...
     * @param listener
     */
    public void addRightBtnWithImageResourceIdAndClickListener(int resId, OnClickListener
            listener) {
    ...
    public void addRightBtnWithImageUrlAndClickListener(String imageUrl, Object tag,
                                                        OnClickListener listener) {
