...
public class ScrollTabs extends RelativeLayout {
    ...
    public ScrollTabs(Context context, AttributeSet attrs) {
        ...
        FrameLayout scrollCon = new FrameLayout(context);//
        // 滚动tab容器，包含一个linearlayout（tabs）和一个cursorview
        ...
        LayoutParams columnBarLp = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams
                .MATCH_PARENT);
        ...
        FrameLayout.LayoutParams selBtnLp = new FrameLayout.LayoutParams((int) (scale * 40),
                (int) (scale * 40));
    ...
    public void addTab(String name) {
        ...
        android.widget.LinearLayout.LayoutParams lp = new android.widget.LinearLayout
                .LayoutParams((int) (padding * 2 + mSelectedTextSize * name.length() + 5),
    ...
    private void scrollIfExceed() {
        if (mCurPos > 0 && mCurPos < ll.getChildCount() - 1) {
            ...
            int temp = 0;
            if ((temp = currentTabTv.getRight() + nextTab.getWidth() - this.getWidth() - mHsv
                    .getScrollX()) > 0
                    || (temp = currentTabTv.getLeft() - preTab.getWidth() - mHsv.getScrollX()) <
                    0) {
    ...
    public void onPageScrolled(int position, float offset) {
        ...
        if (cur != null) {
            ...
            int temp = Color.rgb((int) (mSr - offset * (mSr - mR)), (int) (mSg - offset * (mSg -
                    mG)), (int) (mSb - offset
                    * (mSb - mB)));
        ...
        if (next != null) {
            ...
            LogM.log(this.getClass(), "onPageScrolled lp.width:" + lp.width + "cur.getWidth():" +
                    cur.getWidth() + "offset:"
                    + offset);
            int temp = Color.rgb((int) (mR + offset * (mSr - mR)), (int) (mG + offset * (mSg -
                    mG)), (int) (mB + offset
                    * (mSb - mB)));
