...
public class Utils {
    ...
    public static boolean getBooleanMetaValue(Context context, String metaKey) {
        ...
        try {
            ApplicationInfo ai = pm.getApplicationInfo(context.getPackageName(), PackageManager
                    .GET_META_DATA);
    ...
    public static void setDefaultFont(Context context, String staticTypefaceFieldName, String
            fontAssetName) {
    ...
    // 收藏操作
    public static void toggleCollect(int type, Context context, boolean isCollected, String
            mInfoId, String title, String summy,
...
//		double screenInchSize = Math.sqrt(Math.pow(dm.widthPixels/dm.xdpi, 2)+Math.pow(dm
// .heightPixels/dm.ydpi,2));
        double screenInchSize = Math.sqrt(Math.pow(dm.widthPixels, 2) + Math.pow(dm.heightPixels,
                2)) / (160 * dm.density);
