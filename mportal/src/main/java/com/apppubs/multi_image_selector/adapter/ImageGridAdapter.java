package com.apppubs.multi_image_selector.adapter;
...
public class ImageGridAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (type == TYPE_CAMERA) {
            view = mInflater.inflate(R.layout.list_item_file_choose_camera, viewGroup, false);
            view.setTag(null);
        } else if (type == TYPE_NORMAL) {
            ViewHolde holde;
            if (view == null) {
                view = mInflater.inflate(R.layout.list_item_file_choose_image, viewGroup, false);
